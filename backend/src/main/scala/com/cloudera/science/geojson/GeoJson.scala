...
/** Copyright (c) 2014, Cloudera, Inc. All Rights Reserved.
  *
  * Cloudera, Inc. licenses this file to you under the Apache License, Version 2.0 (the "License").
...
case class Feature(id: Option[JsValue], properties: Map[String, JsValue], geometry: Geometry) {
...
case class GeometryCollection(geometries: Array[Geometry]) extends IndexedSeq[Geometry] {
